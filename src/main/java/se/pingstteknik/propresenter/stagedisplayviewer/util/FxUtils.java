...
public class FxUtils {
    ...
    private GridPane createRoot(Text lowerKey) {
        ...
        String corners = RECTANGLE_CORNERS.toString();
        int cornerBend = Integer.parseInt(corners);

       Rectangle behindText = new Rectangle(0, 0, 1800, 180);
       behindText.setStyle("-fx-fill: " + RECTANGLE_COLOR + "; -fx-opacity: " + RECTANGLE_OPACITY + ";");
       behindText.setArcHeight(cornerBend);
       behindText.setArcWidth(cornerBend);

       root.getChildren().add(behindText);
