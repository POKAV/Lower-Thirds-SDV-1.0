...
public class LowerKeyHandler implements Runnable {
    ...
    private boolean update(BufferedReader in) throws IOException {
        ...
        if (!slide.isEmpty()) {
            ...
            slideText = Property.CAPITALIZE_WORDS.isTrue() //Capitilize whole thing if specified in config.
                    ? capitalizeSlideTranslator.transform(slideText) : slideText;
